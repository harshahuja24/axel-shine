!(function () {
    ...
    if (
      (s(function () {
        ...
        function s(e) {
          setTimeout(function () {
            r(e, ".mbr-parallax-background").forEach(function (e) {
              jarallax &&
                (jarallax(e, { speed: 0.6 }), (e.style.position = "relative"));
            });
          }, 0);
        }
        if (
          (document
            .querySelector("html")
            .classList.add(d() ? "mobile" : "desktop"),
          window.addEventListener("scroll", function () {
            document
              .querySelectorAll(".mbr-navbar--sticky")
              .forEach(function (e) {
                var t = window.scrollTop > 10 ? "add" : "remove";
                e.classList[t]("mbr-navbar--stuck"),
                  e.classList.contains(".mbr-navbar--open") ||
                    e.classList[t]("mbr-navbar--short");
              });
          }),
        ...
        function g(e) {
          r(e, "[data-bg-video]").forEach(function (e) {
            ...
            var o = new URLSearchParams(n),
              ...
              a =
                e.querySelector(".mbr-background-video-preview") ||
            ...
            if (i && (/youtu\.?be/g.test(i[3]) || /vimeo/g.test(i[3]))) {
              if (i && /youtu\.?be/g.test(i[3])) {
                ...
                c.open(
                  "GET",
                  "https://vimeo.com/api/v2/video/" + i[6] + ".json",
                  !0,
                ),
        ...
        if (
          ...
          window.smartresize(function () {
            document
              .querySelectorAll(".mbr-embedded-video")
              .forEach(function (e) {
                e.style.height =
                  (
              ...
              try {
                ...
                do {
                  if (t.hash) {
                    ...
                    document
                      .querySelectorAll(n ? "body" : t.hash)
                      .forEach(function (n) {
                        e.preventDefault();
              ...
              window.scrollY > window.innerHeight
                ? (((t = e).style.display = "block"),
                  (function e() {
                    ...
                    (n += 0.1) > 1 ||
                      ((t.style.opacity = n), requestAnimationFrame(e));
                  })())
                : (function (e) {
                    !(function t() {
      ...
      m &&
        m.addEventListener("click", function (e) {
          ...
          t.classList.contains("engine") &&
            (t = t.closest("section").nextElementSibling),
      ...
      (!t &&
        ...
        e(document).on("add.cards", function (e) {
          ...
          (t.classList.contains("mbr-slider") ||
            t.classList.contains("mbr-gallery")) &&
          ...
          var e = function (e) {
            ...
            n = function (t) {
              ...
              var i = t.parents("section")[0],
                a = i.querySelector(
                  i.querySelector("[data-modal]").getAttribute("data-modal"),
                );
            ...
            .forEach(function (e) {
              ...
              if (t) {
                ...
                if (-1 !== t.indexOf("youtu"))
                  e.setAttribute(
                    "src",
                    "https://youtube.com/embed/" + n[6] + "?rel=0&enablejsapi=1",
                  );
      ...
      if (
        ...
        if (h) {
          ...
          h.querySelector(".navbar").classList.contains("collapsed") ||
            (p > 991 &&
              (h
                .querySelectorAll("ul.navbar-nav li.dropdown")
                .forEach(function (e) {
    ...
    function y(e) {
      var t = e,
        ...
        o =
          ...
          t.getAttribute("data-bs-version").startsWith("5");
      null === t.getAttribute("id") &&
        (n = t.classList.value.match(/cid-.*?(?=\s|$)/) + "-carousel"),
        ...
        (void 0 === window.initClientPlugin &&
          ...
          document.body.querySelectorAll(".clients").forEach(function (e) {
            ...
            e.getAttribute("data-isinit") ||
              ...
              t
                .querySelectorAll(".carousel-item .col-md-12")
                .forEach(function (e) {
                  o < 2
            ...
            .forEach(function (e) {
              e.addEventListener("click", function () {
                ...
                if (
                  ...
                  (e.classList.contains("collapsed")
                    ? (o.classList.remove("mbri-arrow-up"),
                      o.classList.add("mbri-arrow-down"))
                    : (o.classList.remove("mbri-arrow-down"),
      ...
      Array.from(e.children).forEach(function (e) {
        ...
        e.setAttribute(
          ...
          `{ ${(function (e) {
            ...
            if (n) {
              for (
                var o = [], r = Array.from(n.children), i = 0;
                i < r.length;
                i++
              )
      ...
      const e = (t) => {
        ...
        if (r) {
          ...
          const l = () => {
              ...
              (n.target += o),
                (n.current =
                  ((e = n.current), (r = n.target), e * (1 - (a = 0.2)) + r * a)),
    ...
    function E() {
      ...
      e.forEach((e, o) => {
        (e.textContent = t[o]),
          n.observe(e, { attributes: !0, attributeFilter: ["data-word"] });
      });
    ...
    document.querySelectorAll('input[type="range"]').forEach(function (e) {
      ...
      t
        ? e(document).on("add.cards", w)
        : window.addEventListener("DOMContentLoaded", w),
      t
        ? e(document).on("add.cards", E)
